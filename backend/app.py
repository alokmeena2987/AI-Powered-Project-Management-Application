...
# Helper function to generate roadmap (mocked for this implementation)
def generate_roadmap(requirements):
    # In a real implementation, this would call an AI model
    # For now, we're returning a mock roadmap structure in the same format as the AI service
    return {
        "content": f"""
# Project Roadmap

Based on the requirements: {requirements[:100]}...

## Phase 1: Planning & Requirements
- Gather detailed requirements from stakeholders
- Define project scope and objectives
- Create initial project plan with timeline
